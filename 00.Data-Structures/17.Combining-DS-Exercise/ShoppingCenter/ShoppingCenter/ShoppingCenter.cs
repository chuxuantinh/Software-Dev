...
public class ShoppingCenter
{
    ...
    public IEnumerable<Product> FindProductsByPriceRange(decimal low, decimal high)
    {
        return this.byPrice.Range(new Product("", low, ""), true, new Product("", high, ""), true).OrderBy(x => x);
    }
}
