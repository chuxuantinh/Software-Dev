...
{
    private Dictionary<string, List<Person>> personsByName;

    private List<Person> indexedPersons;

    public Organization()
    {
        this.personsByName = new Dictionary<string, List<Person>>();
    ...
    {
        return this.indexedPersons.Contains(person);
    }
    ...
    public void Add(Person person)
    {
        ...
        {
            this.personsByName[person.Name] = new List<Person>();
        }
