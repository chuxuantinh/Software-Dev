...
public class RoyaleArena : IArena
{
    ...
    LinkedList<Battlecard> byInsertion = new LinkedList<Battlecard>();
    Dictionary<int, LinkedListNode<Battlecard>> byId = new Dictionary<int, LinkedListNode<Battlecard>>();
    Dictionary<CardType, OrderedBag<Battlecard>> byType =
        new Dictionary<CardType, OrderedBag<Battlecard>>();
    Dictionary<string, OrderedBag<Battlecard>> byNameAndSwag =
        new Dictionary<string, OrderedBag<Battlecard>>();
    OrderedBag<Battlecard> bySwag;
    ...
    public IEnumerable<Battlecard> GetAllByNameAndSwag()
    {
        ...
        {
            yield return name.Value.GetFirst();//GetFirst?
        }
    }
    ...
    public IEnumerable<Battlecard> GetByCardTypeAndMaximumDamage(CardType type, double damage)
    {
        ...
        return this.byType[type].RangeFrom(new Battlecard(0, CardType.RANGED, "aha", damage, 15), true);//RangeTo?
    }
    ...
    public IEnumerable<Battlecard> GetByNameOrderedBySwagDescending(string name)
    {
        ...
        return this.byNameAndSwag[name];//Ascending?
    }
    ...
    public IEnumerable<Battlecard> GetByTypeAndDamageRangeOrderedByDamageThenById(CardType type, int lo, int hi)
    {
        ...
        return this.byType[type].Range(hig, false, low, false);// low to hig?
    }
    ...
    public void RemoveById(int id)
    {
        ...
        this.byId.Remove(id);
        this.bySwag.Remove(new Battlecard(id, CardType.BUILDING, "aet", 50, toRemove.Value.Swag));
