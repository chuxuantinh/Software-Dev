namespace _01.Microsystem
{
    ...
    public class Microsystems : IMicrosystem
    {
        ...
        Dictionary<Brand, SortedDictionary<double, List<Computer>>> byBrand = new Dictionary<Brand, SortedDictionary<double, List<Computer>>>();
        ...
        public void CreateComputer(Computer computer)
        {
            ...
            {
                byBrand[computer.Brand] = new SortedDictionary<double, List<Computer>>();
            }

            if (!byBrand[computer.Brand].ContainsKey(computer.Price))
            {
                byBrand[computer.Brand][computer.Price] = new List<Computer>();
            }
            byBrand[computer.Brand][computer.Price].Add(computer);
        ...
        public IEnumerable<Computer> GetAllFromBrand(Brand brand)
        {
            ...
            return byBrand[brand].SelectMany(d => byBrand[brand][d.Key]);
