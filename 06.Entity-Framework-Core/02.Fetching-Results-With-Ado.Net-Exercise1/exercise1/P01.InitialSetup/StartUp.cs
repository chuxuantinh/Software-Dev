...
namespace P01.InitialSetup
{
    class StartUp
    {
        private static string connectionString =
            "Server=DESKTOP-B842R2J\\SQLEXPRESS01;" +
            "Database={0};" + 
        ...
        static void Main(string[] args)
        {
            ...
            using (connection)
            {
                try
                {
                    ...
                    SqlCommand creareDbCommand = new SqlCommand(queryText, connection);

                    creareDbCommand.ExecuteNonQuery();
            ...
            using (connection)
            {
                ...
                {
                    Console.WriteLine("There was error processing yout request!");
                    Console.WriteLine(e.Message);
                }
            }
        }
